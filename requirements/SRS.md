...
1.  **Главный экран (Список привычек):**
    ...
    *   При нажатии на карточку (за исключением кнопок) отображается или скрывается график недельной активности.
    ...
    ![Главный экран приложения](https://raw.githubusercontent.com/Chawotto/Momentum/main/mockups/main%20window.png)
    
    *Рисунок 1 - Главный экран со списком привычек*

    ![Раскрытая карточка привычки](https://raw.githubusercontent.com/Chawotto/Momentum/main/mockups/expanded%20card.png)
    
    *Рисунок 2 - Карточка привычки с отображением недельного графика*

3.  **Экран добавления/редактирования привычки:**
    ...
    *   Реализована валидация полей, не позволяющая сохранить привычку с незаполненными или некорректными данными.
    ...
    ![Экран создания привычки](https://raw.githubusercontent.com/Chawotto/Momentum/main/mockups/changing%20window.png)
    
    *Рисунок 3 - Экран создания новой привычки*

5.  **Экран статистики (Сводка за день):**
    ...
    *   Под диаграммой расположен список (легенда) с названиями привычек, их цветами и процентом выполнения цели.
    ...
    ![Экран статистики](https://raw.githubusercontent.com/Chawotto/Momentum/main/mockups/day%20review.png)
...
| Функция | Требования |
| :--- | :--- |
| **Добавление прогресса** | Для каждой привычки должна быть возможность добавить числовое значение, отражающее выполненный за день объем. Прогресс за один день суммируется.<br><br>![Окно добавления прогресса](https://raw.githubusercontent.com/Chawotto/Momentum/main/mockups/adding%20window.png)
